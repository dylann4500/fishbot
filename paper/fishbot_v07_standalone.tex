...
\providecommand{\vsevenHeadCommit}{}\renewcommand{\vsevenHeadCommit}{d017fbc}
...
comparison target, \fishseven{} achieves a \vsevenBtwoFcheap{} percentage-point win-rate edge
...
\vsevenGateBindN{} ask decisions captured from \fishseven{}'s own seats. If no candidate survives the filter the full legal set is
...
$K = \texttt{\vsevenOptStallK{}}$ and $2K = \texttt{\vsevenOptStallTwo{}}$ in \fishseven{}.
...
holdout what it contributes and finds it the largest of the five components \fishseven{} carries,
...
Against the lineage baselines, \fishseven{} gains \vsevenBtwoIncumbent{}~pp over the deployed
...
\fishseven{} is \textbf{\vsevenRegretFrozenRank{}rd of four} on minimax regret (Table~\ref{tab:regret}), at
...
(\S\ref{sec:results-partners}); and over the shared panel \fishseven{} is
...
\item[The live-ask gate's binding rate was the incumbent's, and its sample size a third cell's.] The
  ...
  the gate acts on the argmax of an ask score that \fishseven{} extends with a coordinate
