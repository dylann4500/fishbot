...
\providecommand{\vsevenCostAggDelta}{}\renewcommand{\vsevenCostAggDelta}{0.029}
...
\providecommand{\vsevenDeviations}{}\renewcommand{\vsevenDeviations}{26}
% docs/v07/FINAL-RESULTS.md section 15: entries that are corrections
\providecommand{\vsevenDeviationCorrections}{}\renewcommand{\vsevenDeviationCorrections}{3}
...
\providecommand{\vsevenProvGenerated}{}\renewcommand{\vsevenProvGenerated}{231}
% macros used in sections_v07 that this script does NOT generate, i.e. transcribed
\providecommand{\vsevenProvTranscribed}{}\renewcommand{\vsevenProvTranscribed}{151}
...
At \vsixTieShareFive\% of ask decisions two or more candidates score \emph{bit-for-bit identically},
and the winner is whichever the enumerator emitted first. \vsixTieSameSuitFive\% of those ties are
two cards of one half-suit at one target, and the \emph{exact} posterior --- not merely the
approximation the policy deploys --- assigns them identical probability in
...
A paired lower-confidence-bound deviation rule recovers all of it. Guarded, the search is worth
\vsixSearchPooled\% against the deployed policy over \vsixSearchPooledN{} games at
