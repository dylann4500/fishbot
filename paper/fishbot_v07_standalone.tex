...
% docs/v07/ADVERSARIES.md
\providecommand{\vsevenOneSwitchArmVsFcheap}{+0.55}
\providecommand{\vsevenOneSwitchArmWorst}{-1.69}
\providecommand{\vsevenOneSwitchArmWorstOpp}{Fsearch}
\providecommand{\vsevenContestNegDose}{-1.47}
...
% ---- the live-ask gate's binding rate, measured on the v0.6 policy ----------
% docs/v07/ADVERSARIES.md
\providecommand{\vsevenGateBindRate}{1.0}
\providecommand{\vsevenGateBindN}{260,987}
...
\providecommand{\vsevenHeadCommit}{}\renewcommand{\vsevenHeadCommit}{6a022f4}
...
\providecommand{\vsevenProvTranscribed}{}\renewcommand{\vsevenProvTranscribed}{121}
...
\begin{equation}
  ...
  \frac{\mathbb{1}\!\left[\alpha^\star \in \mathcal{F}_h\right]}{Z}
...
\noindent
No gradient or population fit was run in this cycle; the one coordinate that is not inherited had
its value chosen as the argmax of a measured dose response (\S\ref{sec:agent-policy},
\S\ref{sec:agent-contest}).
